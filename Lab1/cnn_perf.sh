...
do
    ...
    perf stat -o ${curr_path}/output_perf/out_cnn_${code} --append -e mem_inst_retired.all_loads,mem_inst_retired.all_stores,br_inst_retired.all_branches python3 ${curr_path}/cnn_keras.py ${code}
    perf stat -o ${curr_path}/output_perf/out_cnn_${code} --append -e fp_arith_inst_retired.128b_packed_double,fp_arith_inst_retired.128b_packed_single,fp_arith_inst_retired.256b_packed_double,fp_arith_inst_retired.256b_packed_single,fp_arith_inst_retired.scalar_double,fp_arith_inst_retired.scalar_single python3 ${curr_path}/cnn_keras.py ${code}
done
